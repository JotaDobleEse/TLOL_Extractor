...
{
    public class ArtsdataArrNamFiles
    {
        ...
        public static ArtsdataArrNamFiles ReadFiles(string arrPath, string namPath)
        {
            ArtsdataArrNamFiles arrNamFile = new ArtsdataArrNamFiles();
            ...
            using (BinaryReader arrReader = new BinaryReader(File.Open(arrPath, FileMode.Open)))
            {
                ...
                for (int i = 0; i < arrReader.BaseStream.Length; i += 0x28)
                {
                    ...
                    arrNamFile.Blocks.Add(arrReader.ReadBytes(0x20));
        ...
        public static ArtsdataArrNamFiles ReadDataTextFiles(string dataPath, string textPath)
        {
